...
This is the final project for the Thinkful prep course for Software Engineering. It required the use of HTML and CSS to create an example website. [Link] See it here. (https://loganaffleck.github.io/Assignment-Portfolio-Website)
